...
$(document).ready(function()
{
	...
	*/
	...
	9. Init Product Terbaru Slider Home Terb
	...
	*/
	function initProductSlider() 
	{
		...
		{
			var productSlider = $('.product_slider_home'); 
	...
	10. Properti Terpopuler

	*/

	function initPropertiTerpopuler() {
		if($('.properti_terpopuler').length)
		{
			var propertiTerpopuler = $('.properti_terpopuler'); 

			propertiTerpopuler.owlCarousel(
			{ 
				loop:true,
				items:1,
				autoplay: true,
	...
	we willl create a new slider with owl carousel
	
	*/
	
	function initAgenSlider() {
		if($('.agen_slider').length)
		{
			var AgenSlider = $('.agen_slider');
			AgenSlider.owlCarousel({
				loop:true,
				items:1,
				autoplay: true,
				autoplayTimeout:3000,
