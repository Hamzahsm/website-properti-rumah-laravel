				...
				<div class="col-lg-11">
                    ...
                    <form action="#" method="get">
                        ...
                        <div class="col-lg-10">
                            ...
                            <input type="text" class="form-control mb-2" id="inlineFormInput" placeholder="Lokai, Keyword, Area, Project, Developer">
                        </div>
                        <div class="col-lg-2">
							...
							<div class="row">
								...
								<div class="col-lg-8">
									<div class="offers_content">
										...
										<div class="button book_button"><a href="#"><i class="fa fa-whatsapp" aria-hidden="true"></i> Hubungi Penjual</a></div> 
