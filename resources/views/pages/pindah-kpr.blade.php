    ...
    <div class="row">
      <div class="col-lg-4 p-3">
        <div class="border rounded p-3">
          ...
          <ul>
            <li><i class="fa fa-check-circle text-success" aria-hidden="true"></i> Cicilan bulanan KPR bisa lebih murah</li>
            <li><i class="fa fa-check-circle text-success" aria-hidden="true"></i> Bunga di bank baru bisa lebih rendah</li>
            <li><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i> Masa kredit lebih panjang</li>
          </ul>
        </div>
      </div>
      <div class="col-lg-4 p-3">
        <div class="border rounded p-3">
          ...
          <ul>
            <li><i class="fa fa-check-circle text-success" aria-hidden="true"></i> Biaya KPR keseluruhan berkurang</li>
            <li><i class="fa fa-check-circle text-success" aria-hidden="true"></i> Masa kredit KPR bisa lebih cepat selesai</li>
            <li><i class="fa fa-exclamation-circle text-warning" aria-hidden="true"></i> Angsuran bulanan lebih besar</li>
          </ul>
        </div>
      </div>
      <div class="col-lg-4 p-3">
...
<div class="intro">
  <div class="container">
      <div class="row">
          <div class="col-3">
            <h4 class="font-weight-bold mb-3 text-dark text-start">Seputar Pindah KPR</h4>
