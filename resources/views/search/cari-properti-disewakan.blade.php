                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="blog_post_container"> 
                            <h3 class="text-dark">Hasil Pencarian : {{ request()->keyword }}</h3>
                            <p class="text-dark">Ditemukan : {{ $results->count() }} data</p>
                           ...
                           <div class="blog_post">
                               <div class="blog_post_image">
                                   <img src="{{ Storage::url($item->featured_image) }}" alt="https://unsplash.com/@anniespratt">
                               </div>
                               <div class="blog_post_meta">
                                   <ul>
                                       <li class="blog_post_meta_item"><a href="">by Lore Papp</a></li>
                                       <li class="blog_post_meta_item"><a href="">{{ $item->lokasi_properti }}</a></li>
                                       <li class="blog_post_meta_item"><a href="">{{ $item->provinsi_properti }}</a></li>
                                       <li class="blog_post_meta_item"><a href="">{{ $item->created_at->diffForHumans() }}</a></li>
                                   </ul>
                               </div>
                               <div class="blog_post_title"><a href="/single-listing/{{ $item->id }}">{{ $item->judul_properti }}</a></div>
                               <div class="blog_post_text">
                                   <p>{{ $item->deskripsi_properti }}</p>
                               </div>
                               <div class="blog_post_link"><a href="/single-listing/{{ $item->id }}">Detail</a></div>
                           </div>
                               
                           @endforeach
                        </div>
                        @else 
                        <p>Pencarian : {{ request()->keyword }} tidak ditemukan. Coba cari dengan keyword lain</p>
                        @endif
                    ...
                    <div class="col-lg-4 sidebar_col">
                        ...
                        <div class="sidebar_search">
                            <form action="{{ route('cari.properti.disewakan') }}" method="GET">
