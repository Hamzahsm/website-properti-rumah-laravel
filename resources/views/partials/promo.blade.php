	...
	<div class="cta">
		...
		{{-- <div class="cta_background" style="background-image:url({{ asset('images/home-slider-new-1.jpg') }})"></div> --}}
					...
					<div class="cta_slider_container">
						<div class="owl-carousel owl-theme cta_slider">
							...
							<div class="owl-item cta_item text-center">
                                <img src="{{ asset('images/promo-home.jpg') }}" alt="">
							</div>

							<!-- CTA Slider Item -->
							<div class="owl-item cta_item text-center">
                                <img src="{{ asset('images/promo-home-2.jpg') }}" alt="">
							</div>
