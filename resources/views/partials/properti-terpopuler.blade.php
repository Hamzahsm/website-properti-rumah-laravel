	...
	<div class="intro">
		<div class="container">
			<div class="row">
				<div class="col">
					<h2 class="intro_title text-start fs-3">Properti Terpopuler</h2>
                    <p class="intro_text text-start text-dark">Iklan properti terpopuler dengan lokasi strategis dan harga menarik</p>
				</div>
			</div>

            <div class="product_slider">
                <div class="owl-carousel owl-theme properti_terpopuler">
