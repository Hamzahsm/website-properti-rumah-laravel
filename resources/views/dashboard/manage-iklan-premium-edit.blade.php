...
<section class="section dashboard">
    ...
    <form action="{{ route('ads.update', $data->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                ...
                <textarea name="deskripsi_properti" id="" cols="30" rows="10" class="form-control">{{ $data->deskripsi_properti }}</textarea>
            </div>
